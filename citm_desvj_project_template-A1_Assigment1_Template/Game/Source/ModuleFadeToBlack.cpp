...
ModuleFadeToBlack::ModuleFadeToBlack(App* app, bool start_enabled) : Module( start_enabled) {
	screenRect = { 0, 0,app->scene->windowW  * app->win->GetScale(), app->scene->windowH * app->win->GetScale() };
}
